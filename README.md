...
~~~bash
git clone "https://github.com/viccom/guacamole_docker.git"
cd guacamole_docker
./prepare.sh
docker-compose up -d
~~~

Your guacamole server should now be available at `https://ip or domain/`.   
...
The following part of docker-compose.yml will create an instance of npc that map the Guacamole to internet. before you use npc, You need to set up an nps server on the Internet . Please refer to "https://ehang-io.github.io/nps/#/install" for the installation of nps server. modify "npserver" and "npckey"
